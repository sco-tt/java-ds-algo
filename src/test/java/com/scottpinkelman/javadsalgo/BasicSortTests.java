...
public class BasicSortTests implements IntArrayTimedTest {
  ...
  public void testBubbleSortMatchesSorted() {
    int[] result = invoke(BubbleSort.class.getSimpleName(), BubbleSort::run, IntArrayDataUtil.getUnsortedIntArray());
  ...
  public void testSelectionSortMatchesSorted() {
    int[] result = invoke(SelectionSort.class.getSimpleName(), SelectionSort::run, IntArrayDataUtil.getUnsortedIntArray());
    assertArrayEquals(IntArrayDataUtil.getSortedIntArray(), result);
  }
}
